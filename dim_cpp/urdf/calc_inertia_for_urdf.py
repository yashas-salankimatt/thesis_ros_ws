...
# Command line params:
# 1: URDF file- note that this only works with the actual base macrco- any file that calls the macro will fail for somw reason
...
if __name__ == '__main__':
    print("Starting URDF inertia calculator...")
    print("Loading URDF file: " + sys.argv[1])
